...
public class EnergyPortScreen extends AbstractContainerScreen<EnergyPortMenu> {
    ...
    public EnergyPortScreen(EnergyPortMenu menu, Inventory inv, Component title) {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        int pct = cap > 0 ? (int) ((long) e * 100 / cap) : 0;
        graphics.text(font, Component.literal(pct + "%"), infoX, infoY + 60, COLOR_TEXT, false);
    }
